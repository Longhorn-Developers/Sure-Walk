/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: dcebf73d1a30c029cbc024aaecffdee4)
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: "RideInfoStream";
  }
  interface Env {
    LIFTS_DB: D1Database;
    ASSETS: Fetcher;
    ...
    RIDE_INFO_STREAM: DurableObjectNamespace<
      import("./custom-worker").RideInfoStream
    >;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      "JWT_SECRET" | "REFRESH_TOKEN_SECRET" | "SAMSARA_API_KEY"
    >
  > {}
}
